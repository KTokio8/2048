...
//Faire une marche
void QT2048::move(Move_Direction direction)
{
    added(direction);
    moved(direction);
...
QColor QT2048::color(const int &index)
{
...
QColor QT2048::numColor(const int &index)
{
     return QColor(255, 255, 255);
}

//Initialisaser les parametres
void QT2048::initNum()
{
    m_number.clear();
...
//Obtenir la valeur du ponit
int QT2048::score() const
{
    return m_score;
}

//Obtenir la valeur du meilleur ponit
int QT2048::bestScore() const
{
    return m_bestScore;
}

//Obtenir la valeur de la marche
int QT2048::step() const
{
    return m_step;
}

//Obtenir la valeur de la marche totale
int QT2048::totalStep() const
{
    return m_totalStep;
}

//Obtenir la valeur des carreaux
int QT2048::show(const int &index)
{
...
//Calculer la sommation de 2 carreaux voisines qui ont la meme valeur iterativement
void QT2048::added(Move_Direction direction)
{
...
//Rassembler des carreaux
void QT2048::moved(Move_Direction direction)
{
    if(Move_Down == direction) {
        m_movedFlag = false;
        for(int c = 0; c < COLUMNS; c++) {
...
//Ajouter un nouveau carreau de la valuer 2 dans des grilles vides par aleatoire
void QT2048::freshed(bool fresh)
{
    if(fresh) {
        m_step += 1;
        m_totalStep = m_step;
